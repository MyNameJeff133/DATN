...
import AdminContentFeedback from "./adminPages/AdminContentFeedback";
...
import { syncAuthStorage } from "./services/authStorage";
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="content-feedback" element={<AdminContentFeedback />} />
